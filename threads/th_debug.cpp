...
PI_THREAD(DebugThread)
{
	...
	while (settings->threadFlag.DebugThread)
	{
		...
		printf("----------------------");
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.RFIDWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("RFIDWatch         : ");
		printf("%1d|", (settings->workFlag.RFIDWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.CoinWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("CoinWatch         : ");
		printf("%1d|", (settings->workFlag.CoinWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.CoinPulseWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("CoinPulseWatch    : ");
		printf("%1d|", (settings->workFlag.CoinPulseWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.MoneyWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("MoneyWatch        : ");
		printf("%1d|", (settings->workFlag.MoneyWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.EngineWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("EngineWatch       : ");
		printf("%1d|", (settings->workFlag.EngineWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.ButtonWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("ButtonWatch       : ");
		printf("%1d|", (settings->workFlag.ButtonWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.DataExchangeThread < 2)	term_setattr(32);
		else term_setattr(31);
		printf("DataExchangeThread: ");
		printf("%1d|", (settings->workFlag.DataExchangeThread < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.NetServer < 2)	term_setattr(32);
		else term_setattr(31);
		printf("NetServer         : ");
		printf("%1d|", (settings->workFlag.NetServer < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.NetClient < 2)	term_setattr(32);
		else term_setattr(31);
		printf("NetClient         : ");
		printf("%1d|", (settings->workFlag.NetClient < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.MonitorWatch < 2)	term_setattr(32);
		else term_setattr(31);
		printf("MonitorWatch      : ");
		printf("%1d|", (settings->workFlag.MonitorWatch < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.ExtCommonThread < 2)	term_setattr(32);
		else term_setattr(31);
		printf("ExtCommonThread   : ");
		printf("%1d|", (settings->workFlag.ExtCommonThread < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.IntCommonThread < 2)	term_setattr(32);
		else term_setattr(31);
		printf("IntCommonThread   : ");
		printf("%1d|", (settings->workFlag.IntCommonThread < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.TimeTickThread < 2)	term_setattr(32);
		else term_setattr(31);
		printf("TimeTickThread    : ");
		printf("%1d|", (settings->workFlag.TimeTickThread < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		if (settings->workFlag.DebugThread < 2)	term_setattr(32);
		else term_setattr(31);
		printf("DebugThread       : ");
		printf("%1d|", (settings->workFlag.DebugThread < 2));
		cur_gotoxy(scr_x-23, dbg_pos++);
		...
		printf("Winter mode    : %1d(%1d)|", settings->winterMode.winterMode, winterModeActive);
		cur_gotoxy(scr_x-23, dbg_pos++);
		printf("----------------------");
		cur_gotoxy(scr_x-23, dbg_pos++);
		term_setattr(35);
...
//		printf("CCTalk Bill Vl %1d", (!ccTalkBillDevice->IsOpened() && settings->threadFlag.MoneyCCTalkWatch));	// 17 chars
		...
		printf("----------------+");	// 17 chars
		cur_gotoxy(scr_x-63, dbg_pos++);
		printf("Queue cnt: %5d", queueLog->QueueCount);	// 17 chars
		printf("|");
