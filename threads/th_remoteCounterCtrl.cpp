...
// Поток отвечает за рассылку команд и сбор данных с устройств слежения по протоколу
// MODBUS RS-485. Собираемые данных содеожат количество импульсов считаных с "ЧУЖОГО"
// устройства в разрезе стоимости импульса
// *************************
// Работает в связке с 	AlienDeviceWatch
//						KKMWatch
//
