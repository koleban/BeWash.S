...
bool Settings::loadConfig (char* fileName)
{
	...
	modbus.dataParity 					= (char)(0xFF & iniparser_getuint(ini, 	"Modbus:PARITY",		'N'));	// ÏÐÈÍÈÌÀÅÒ "ÑÈÌÂÎË" (char) Val: 'N' 'O' 'D'
	...
	sprintf(kkmParam.ServiceName, "%s", iniparser_getstring(ini,	"KKM:ServiceName", "Àðåíäà àâòîìîå÷íîãî îáîðóäîâàíèÿ"));
